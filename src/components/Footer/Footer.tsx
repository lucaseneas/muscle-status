    ...
    return(
        <footer className="bg-primary fixed bottom-0 w-screen h-16 flex items-center justify-center text-secondary">
                <div className="w-1/3 h-full flex flex-col items-center justify-center ">
                    <div className="h-full w-2/3 hover:brightness-150 focus:brightness-150 bg-primary rounded-full flex flex-col items-center justify-center ">
                        <img className="h-3/6" src='https://img.icons8.com/?size=100&id=123782&format=png&color=00C2CB' />
                        <p>Amigos</p>
                    </div>
                </div>
                <div className="w-36 h-28 mb-6 flex flex-col items-center justify-center ">
                    <div className="h-full w-2/3 hover:brightness-150 focus:brightness-150 bg-primary rounded-full flex flex-col items-center justify-center ">
